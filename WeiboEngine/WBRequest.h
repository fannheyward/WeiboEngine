...
typedef enum {
    WBRequestTypeNone               = 0,
    WBRequestTypeStatusesUpdate,
    WBRequestTypeStatusesUpload,
    WBRequestTypeUsersShow,
    WBRequestTypeFriendshipsCreate,
    WBRequestTypeFriendshipsFriendsBilateral,
    WBRequestTypeFriendshipsFriends,
    WBRequestTypeFriendshipsShow,
    //...
} WBRequestType;
...
@property WBRequestType requestType;
